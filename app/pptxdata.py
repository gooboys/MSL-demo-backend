...
def true_replacement(stats, patient, education, competitive, single):
  ...
  ref = {
    146: {"text": safe_get(single, 0, "Raw CRM Input (from MSL)"),
          "font": "Century Gothic", "font_size": 12, "font_color": hex_to_rgb("28246f"), "bold": True},
    ...
    218: {"text": "Theme 1 (n="+str(len(patient[0]["other_sources"])+3)+")",
    ...
    273: {"text": "1: "+education[2]["root_cause_questions"][0]+"\n"+"2: "+education[2]["root_cause_questions"][1],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    # END SLIDE 4
    247: {"text": "Theme 1 (n="+str(len(competitive[0]["other_sources"])+3)+")",
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    256: {"text": "Theme 2 (n="+str(len(competitive[1]["other_sources"])+3)+")",
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    265: {"text": "Theme 3 (n="+str(len(competitive[2]["other_sources"])+3)+")",
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    251: {"text": competitive[0]["gap_definition"],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    260: {"text": competitive[1]["gap_definition"],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    269: {"text": competitive[2]["gap_definition"],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    ...
    271: {"text": "\n".join([f"id {q['id']}: '{q['quote']}'" for q in competitive[2]["representative_quotes"]]),
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    255: {"text": "1: "+competitive[0]["root_cause_questions"][0]+"\n"+"2: "+competitive[0]["root_cause_questions"][1],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    264: {"text": "1: "+competitive[1]["root_cause_questions"][0]+"\n"+"2: "+competitive[1]["root_cause_questions"][1],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")},
    273: {"text": "1: "+competitive[2]["root_cause_questions"][0]+"\n"+"2: "+competitive[2]["root_cause_questions"][1],
          "font": "Century Gothic", "font_size": 14, "font_color": hex_to_rgb("28246f")}
    # END SLIDES (5)
  }
  ...
  items = {
    ...
    195: ('Google Shape;596;p45', 6), 198: ('Google Shape;600;p45', 6), 199: ('Google Shape;602;p45', 6),
    200: ('Google Shape;603;p45', 6), 201: ('Google Shape;605;p45', 6), 202: ('Google Shape;606;p45', 6),
    203: ('Google Shape;608;p45', 6), 204: ('Google Shape;609;p45', 6), 205: ('Google Shape;611;p45', 6),
    206: ('Google Shape;612;p45', 6), 207: ('Google Shape;614;p45', 6), 208: ('Google Shape;615;p45', 6),
    209: ('Google Shape;617;p45', 6), 210: ('Google Shape;618;p45', 6), 211: ('Google Shape;620;p45', 6),
    212: ('Google Shape;621;p45', 6), 213: ('Google Shape;623;p45', 6), 218: ('Google Shape;633;p46', 7),
    222: ('Google Shape;637;p46', 7), 224: ('Google Shape;639;p46', 7), 226: ('Google Shape;641;p46', 7),
    227: ('Google Shape;642;p46', 7), 231: ('Google Shape;646;p46', 7), 233: ('Google Shape;648;p46', 7),
    235: ('Google Shape;650;p46', 7), 236: ('Google Shape;651;p46', 7), 242: ('Google Shape;657;p46', 7),
    244: ('Google Shape;659;p46', 7), 247: ('Google Shape;667;p47', 8), 250: ('Google Shape;670;p47', 8),
    251: ('Google Shape;671;p47', 8), 253: ('Google Shape;673;p47', 8), 255: ('Google Shape;675;p47', 8),
    256: ('Google Shape;676;p47', 8), 260: ('Google Shape;680;p47', 8), 262: ('Google Shape;682;p47', 8),
    264: ('Google Shape;684;p47', 8), 265: ('Google Shape;685;p47', 8), 269: ('Google Shape;689;p47', 8),
    271: ('Google Shape;691;p47', 8), 273: ('Google Shape;693;p47', 8), 276: ('Google Shape;701;p48', 9),
    280: ('Google Shape;705;p48', 9), 282: ('Google Shape;707;p48', 9), 284: ('Google Shape;709;p48', 9),
    285: ('Google Shape;710;p48', 9), 289: ('Google Shape;714;p48', 9), 291: ('Google Shape;716;p48', 9),
    293: ('Google Shape;718;p48', 9), 294: ('Google Shape;719;p48', 9), 298: ('Google Shape;723;p48', 9),
    300: ('Google Shape;725;p48', 9), 302: ('Google Shape;727;p48', 9)
  }
